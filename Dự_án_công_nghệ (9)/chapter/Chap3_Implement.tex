...
\begin{table}[H]
    ...
    \begin{tabular}{|p{1.4cm}|p{4.8cm}|p{4.5cm}|p{3.0cm}|}
        ...
        \hline
        run46 & + Curriculum (3 mức độ khó) & Đánh giá curriculum learning & MT2 \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{p{4.0cm} p{5.0cm} p{5.0cm}}
        ...
        Tổ chức dữ liệu & Không gắn với các giai đoạn độ khó của môi trường Unity. & Chia bản đồ thành Easy/Medium/Hard theo percentile để điều khiển độ khó huấn luyện. \\
