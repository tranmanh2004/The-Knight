...
\chapter[{KẾT LUẬN VÀ HƯỚNG NGHIÊN CỨU TIẾP THEO}]{Kết luận và hướng nghiên cứu tiếp theo}
...
\begin{table}[H]
    \centering
    \small
    \caption{Kết quả đạt được theo từng mục tiêu đề tài, đối chiếu với tiêu chí đánh giá ở Mục~\ref{sec:eval_thresholds}}
    \label{tab:mt_results_summary}
    \begin{tabular}{|c|p{3.8cm}|p{4.0cm}|p{2.3cm}|p{1.6cm}|}
        \hline
        \textbf{MT} & \textbf{Mục tiêu} & \textbf{Kết quả \& tiêu chí} & \textbf{Cấu hình/so sánh} & \textbf{Đánh giá} \\
        \hline
        MT1 & Tác nhân chiến đấu hiệu quả trong Roguelike & clear\_rate 0.666, đạt ngưỡng 0.5; 1.58 kills/episode & run62 & Đạt \\
        \hline
        MT2 & Giảm khó khăn do phần thưởng thưa và bản đồ thay đổi & Curriculum learning cải thiện 85\%, vượt ngưỡng 20\% (2.073 $\rightarrow$ 3.843) & run34 vs run46 & Đạt \\
        \hline
        MT3 & Xác định kỹ thuật hỗ trợ có tác động lớn nhất & Curriculum learning tạo cải thiện đáng kể (+85\%); ICM/RND/LSTM chỉ +16--20\% (cải thiện nhẹ) & run46 vs run35/36/42 & Đạt \\
        \hline
        MT4 & Kiểm tra nút thắt quan sát & Entropy giảm 1.35 nat, vượt ngưỡng 1 nat; clear\_rate 0.666 tiệm cận cấu hình có hỗ trợ BFS (0.846) & run59, run62 & Đạt trong phạm vi một seed \\
        \hline
    \end{tabular}
\end{table}

\noindent Các kết quả thực nghiệm cho thấy đề tài đã đáp ứng các tiêu chí đặt ra cho MT1--MT4 theo các ngưỡng ở Mục~\ref{sec:eval_thresholds}. Tuy nhiên, do mỗi cấu hình chỉ chạy một seed, các kết luận này được hiểu là bằng chứng thực nghiệm có cơ sở, chưa phải kết luận thống kê có khoảng tin cậy.
...
Kết quả thực nghiệm cho thấy curriculum learning là xu hướng nổi bật nhất trong nhóm thí nghiệm loại trừ về kỹ thuật huấn luyện. PPO cơ sở trên nhóm bản đồ khó chỉ đạt phần thưởng tail-50 (trung bình 50 lượt chơi cuối) 2.073, còn run46 với curriculum đạt trung bình trên Hard 3.843 -- cải thiện khoảng 85\%. Khi ghép ICM lên nền curriculum, run50 đạt 4.369 phần thưởng và 1.016 kills/episode. Có thể thấy phần thưởng nội tại có tác dụng bổ trợ rõ rệt khi tác nhân đã được làm quen với các mức độ dễ hơn. Biến thể chuyển từ vị trí sinh cố định sang ngẫu nhiên trong run54 đạt 3.925, cho thấy tổ chức độ khó môi trường là yếu tố nền quan trọng. Ở nhóm thí nghiệm mở rộng về biểu diễn quan sát, run59 với đặc trưng \emph{path-informed} (quan sát có thông tin đường đi BFS) đem lại mức cải thiện đáng kể nhất: tỷ lệ dọn phòng ở cuối quá trình huấn luyện khoảng 0.846, số kẻ địch tiêu diệt ở cuối quá trình huấn luyện khoảng 1.78 và entropy giảm khỏi vùng bão hòa quanh 4.40 nat xuống khoảng 3.62 ở vùng cuối.

Cuối cùng, run62 kết hợp quan sát lưới cục bộ, curriculum 4 bậc, ICM và huấn luyện dài 40.82M bước. Cấu hình này đạt phần thưởng tail-50 14.913, tỷ lệ dọn phòng tail-50 0.666, số kẻ địch tiêu diệt tail-50 1.582 và entropy tail-50 3.048 -- thấp hơn rõ rệt vùng bão hòa 4.40 nat quan sát ở các thí nghiệm loại trừ 1--3M bước với quan sát 207 chiều. Vùng bão hòa này không phải giới hạn cứng của PPO hay không gian hành động. Vì run62 thay đổi nhiều yếu tố đồng thời, nguyên nhân cụ thể vẫn chưa được cô lập hoàn toàn. Toàn bộ kết quả chưa kèm khoảng sai số vì mỗi cấu hình chỉ chạy một seed; chúng nên được diễn giải như bằng chứng thực nghiệm ban đầu thay vì kết luận thống kê cuối cùng.
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{4.0cm}|p{3.5cm}|p{6.5cm}|}
        ...
        \hline
        PPO cơ sở & 2.073 phần thưởng tail-50 & Mốc so sánh khi không dùng curriculum. \\
        \hline
        ...
        \hline
        Run59 (\emph{path-informed}) & tỷ lệ dọn phòng ở cuối quá trình huấn luyện khoảng 0.846, số kẻ địch tiêu diệt ở cuối quá trình huấn luyện khoảng 1.78 & Cải thiện lớn về biểu diễn quan sát; bổ sung tín hiệu tìm đường giúp tác nhân tiếp cận và tiêu diệt kẻ địch ổn định hơn. \\
        \hline
        Run62 (lưới cục bộ, 40.82M bước) & 14.913 phần thưởng tail-50, tỷ lệ dọn phòng 0.666, entropy 3.048 & Thoát khỏi vùng bão hòa entropy; tỷ lệ dọn phòng tiệm cận cấu hình có hỗ trợ BFS dù không được cung cấp trực tiếp hướng đi tối ưu. \\
        \hline
        Vùng bão hòa entropy & 4.40 nat (thí nghiệm loại trừ 1--3M bước); 3.048 nat (run62, 40.82M bước) & Run62 thoát khỏi vùng bão hòa cũ khi kết hợp quan sát lưới cục bộ, curriculum, ICM và 40.82M bước huấn luyện. \\
        \hline
    \end{tabular}
\end{table}

Các thí nghiệm ICM, RND và LSTM đem lại thông tin bổ sung nhưng không làm thay đổi xu hướng chính. Khi chạy độc lập, ICM có dấu hiệu inverse model học yếu trên không gian hành động nhiều nhánh; RND cải thiện nhẹ hơn ICM nhưng chưa vượt rõ mốc so sánh; LSTM học chậm và tăng dần nhưng chưa tạo cải thiện đáng kể trong quy mô huấn luyện hiện tại. Khi ghép với curriculum, LSTM không có tác dụng bổ trợ rõ, còn ICM trong run50 giúp tăng phần thưởng và số lần tiêu diệt nhưng inverse loss vẫn cao.
...
\begin{itemize}
    \item \textbf{Quy trình thực nghiệm hoàn chỉnh cho RL trong game hành động Roguelike.} Quy trình trải dài từ thiết kế quan sát/hành động, sinh bản đồ bằng PCGNN, chuẩn hóa bản đồ sang \texttt{TextAsset} của Unity, kiểm tra khả năng đi tới bằng BFS, đến huấn luyện PPO qua Unity ML-Agents. Quy trình không chỉ chạy trên một bản đồ cố định mà còn mở rộng sang tập bản đồ được phân loại theo độ khó.
...
\begin{itemize}
    ...
    \item \textbf{Quy mô huấn luyện chưa đồng nhất giữa các nhóm.} Nhóm không dùng curriculum chủ yếu dừng ở 1.0M bước, nhóm curriculum chạy đến 3.0M bước, còn run62 đạt 40.82M bước. Một số so sánh do đó phản ánh hiệu quả của cấu hình hoàn chỉnh hơn là so sánh từng biến trong cùng điều kiện huấn luyện.

    \item \textbf{Điều hướng trong bản đồ sinh theo thủ tục là nút thắt còn lại.} Run59 cho thấy bài toán này chưa được giải quyết hoàn toàn bằng quan sát cục bộ 207 chiều. Khi bổ sung hướng bước tiếp theo theo BFS và khoảng cách đường đi ngắn nhất vào tín hiệu học, hiệu năng tăng rõ rệt. Có thể xem run59 như thí nghiệm mở rộng về biểu diễn quan sát: yếu tố tìm đường có tác động lớn tới khả năng tiếp cận và tiêu diệt kẻ địch.

    \item \textbf{Nguyên nhân chính xác của vùng bão hòa entropy chưa được cô lập.} Run62 thoát khỏi vùng bão hòa bằng cách kết hợp nhiều thay đổi đồng thời (lưới cục bộ, curriculum 4 bậc, ICM, siêu tham số đã điều chỉnh và số bước huấn luyện lớn hơn), nhưng chưa có thí nghiệm đơn biến nào xác định yếu tố nào là nguyên nhân chính. Một số hướng như giảm số hướng ngắm, gộp nhánh chiến đấu--ngắm, thay đổi hệ số entropy, chính sách phân rã (\emph{factorized policy}) hay khởi tạo bằng học bắt chước vẫn chưa được kiểm tra.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Thiết kế lại không gian hành động.} Không gian $(3,3,3,9)$ tuy đủ để biểu diễn điều khiển game nhưng làm entropy cao và khiến chính sách khó trở nên quyết đoán. Có thể gộp nhánh chiến đấu--ngắm, giảm số hướng ngắm, hoặc lọc tập hành động hợp lệ theo ngữ cảnh.
    ...
    \item \textbf{Tiếp tục khai thác quan sát lưới cục bộ.} Run62 cho thấy khi tăng số bước huấn luyện lên 40.82M, lưới cục bộ có thể đạt tỷ lệ dọn phòng tiệm cận cấu hình có hỗ trợ BFS dù không được cung cấp trực tiếp hướng đi tối ưu. Bước tiếp theo là tăng độ phân giải lưới, kết hợp với quan sát pixel hoặc đặc trưng đồ thị để kiểm tra khả năng khái quát hóa sang các bản đồ chưa từng thấy.

    \item \textbf{Khởi tạo bằng học bắt chước hoặc sao chép hành vi.} Với một tập minh họa nhỏ từ người chơi, tác nhân có thể bắt đầu từ chính sách biết di chuyển, né và tấn công cơ bản, rồi dùng PPO/curriculum để tinh chỉnh trên nhóm bản đồ khó. Hai hướng này tương ứng với \emph{imitation learning} và \emph{behavior cloning}.
    ...
    \item \textbf{Mở rộng sang huấn luyện đa tác nhân.} Môi trường TopDown Engine hỗ trợ nhiều nhân vật và nhiều kẻ địch. Các kịch bản hợp tác hoặc đối kháng là hướng tự nhiên để kiểm tra khả năng phối hợp, chia mục tiêu và thích nghi chiến thuật của tác nhân.
\end{itemize}
