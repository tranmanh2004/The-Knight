...
\begin{itemize}
    ...
    \item Chương 4: Kết quả thực nghiệm và đánh giá -- Phân tích các lượt chạy từ run34 đến run55, so sánh PPO cơ sở, ICM, RND, LSTM, curriculum learning, thiết kế lại phần thưởng và hiện tượng entropy bão hòa.
