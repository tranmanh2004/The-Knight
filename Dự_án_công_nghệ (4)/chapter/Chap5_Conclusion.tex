...
\begin{table}[H]
    ...
    \begin{tabular}{|p{4.5cm}|c|p{7cm}|}
        ...
        \hline
        Path-informed run59/run61 & 0.846 cleared tail, 1.78 kills tail & Bước đột phá về biểu diễn quan sát; bổ sung tín hiệu pathfinding giúp agent tiếp cận và tiêu diệt enemy ổn định hơn. \\
        \hline
...
Đóng góp thứ năm là phát hiện entropy plateau. Trong phạm vi các ablation chính đã thử, entropy của policy duy trì quanh 4.40 nat bất kể thay đổi ICM, RND, LSTM, curriculum, giảm phương sai spawn hoặc reward redesign. Đây là một chỉ dấu quan trọng cho các nghiên cứu tiếp theo về thiết kế action space và inductive bias cho agent game hành động.

Đóng góp thứ sáu là ablation mở rộng về biểu diễn quan sát thông qua run59. Khi bổ sung đặc trưng path-informed dựa trên BFS, agent đạt bước cải thiện lớn nhất về hành vi: tỷ lệ dọn phòng, số enemy tiêu diệt và mức độ quyết đoán của policy đều tốt hơn rõ rệt. Kết quả này cho thấy biểu diễn không gian là yếu tố quyết định trong môi trường procedural combat, và mở ra hướng kết hợp RL với các đặc trưng navigation có cấu trúc thay vì chỉ thay đổi thuật toán huấn luyện.
...
Một hạn chế bổ sung được rút ra từ run59 là bài toán navigation trong bản đồ procedural chưa được giải quyết hoàn toàn bằng quan sát cục bộ 207 chiều. Khi bổ sung hướng bước tiếp theo theo BFS và khoảng cách đường đi ngắn nhất vào tín hiệu học, hiệu năng tăng rõ. Vì vậy, run59 được xem là một ablation mở rộng về biểu diễn quan sát, cho thấy yếu tố pathfinding có tác động lớn tới khả năng tiếp cận và tiêu diệt kẻ địch, đồng thời gợi ý rằng navigation là một nút thắt quan trọng của môi trường hiện tại.
