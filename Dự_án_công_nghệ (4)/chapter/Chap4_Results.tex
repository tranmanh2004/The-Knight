...
Trong phạm vi các ablation chính giữ nguyên observation 207 chiều, plateau này không được giải quyết bởi ICM, RND, LSTM, curriculum learning, giảm phương sai spawn hoặc reward redesign. Kết luận thận trọng là: entropy plateau là giới hạn thực nghiệm quan sát được trong thiết kế action space và môi trường hiện tại, chưa phải một định lý về PPO. Hướng tiếp theo hợp lý là đơn giản hóa action space, gom bớt branch hoặc thêm inductive bias cho ngắm và né đạn.
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{4.1cm}|p{3.2cm}|p{6.4cm}|}
        ...
        \hline
        Cleared-room rate & 0.727 cuối run; tail gần cuối khoảng 0.846 & Agent dọn phòng ổn định hơn khi được cung cấp tín hiệu đường đi. \\
        \hline
        Episode kills & 1.55 cuối run; tail gần cuối khoảng 1.78 & Số enemy bị tiêu diệt tăng, cho thấy navigation là một nút thắt thực tế của bài toán. \\
        \hline
        ...
        \hline
        Enemy stuck recoveries & Tail gần cuối khoảng 3.07 mỗi episode & Môi trường vẫn còn nhiễu do enemy bị kẹt hoặc cần recovery, nên kết quả cần được đọc kèm hạn chế runtime. \\
        \hline
    \end{tabular}
\end{table}

Kết quả của Bảng~\ref{tab:run59_bfs_assisted} cho thấy khi bổ sung tín hiệu đường đi ngắn nhất, các chỉ số hành vi tăng mạnh hơn: tỷ lệ dọn phòng đạt trên 0.8 ở vùng cuối, số enemy bị tiêu diệt trung bình vượt 1.7 và entropy giảm sâu hơn so với plateau của các run 207 chiều. Đây là bước đột phá thực nghiệm lớn nhất trong toàn bộ quá trình thử nghiệm, vì nó không chỉ làm reward tăng mà còn cải thiện trực tiếp các chỉ số hành vi như clear rate, kills và mức độ quyết đoán của policy. Điều này cho thấy nút thắt chính của môi trường không chỉ nằm ở thuật toán PPO hay cơ chế exploration, mà còn nằm ở biểu diễn không gian của observation. Khi agent được cung cấp đặc trưng đường đi phù hợp hơn, policy có thể học hành vi tiếp cận và chiến đấu ổn định hơn. Run59 vì vậy được xem là bước đột phá về biểu diễn quan sát, đồng thời gợi ý rằng các hướng tiếp theo nên tập trung vào local occupancy grid, graph/path feature học được, imitation learning cho navigation, hoặc thiết kế lại map/enemy để giảm nhiễu từ các tình huống kẹt.

Do đó, run59 là bước cải thiện lớn nhất về hiệu năng thực nghiệm, nhưng bản chất của cải thiện này đến từ thay đổi biểu diễn quan sát chứ không chỉ từ thay đổi thuật toán học. Kết quả này không chứng minh agent đã tự học pathfinding hoàn toàn, mà cho thấy khi được cung cấp đặc trưng đường đi phù hợp hơn, policy có thể học hành vi combat và tiếp cận mục tiêu ổn định hơn.

Từ bảng tổng hợp, bốn nhận xét chính được rút ra trong phạm vi thí nghiệm một seed. Thứ nhất, PPO baseline đạt hành vi hợp lý nhưng bị giới hạn ở mức reward khoảng 2.1--2.5. Thứ hai, intrinsic motivation và LSTM chưa tạo cải thiện lớn khi chạy độc lập. Thứ ba, curriculum learning là yếu tố nổi bật nhất; khi kết hợp thêm ICM, reward Hard tăng lên 4.369 nhưng inverse loss vẫn cao. Thứ tư, entropy plateau vẫn tồn tại trong nhóm ablation chính 207 chiều, cho thấy cần nghiên cứu thêm về action space và cấu trúc policy.
