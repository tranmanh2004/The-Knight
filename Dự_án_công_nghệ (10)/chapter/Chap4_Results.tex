...
\subsection{Quy ước đánh giá thực nghiệm}
...
\section{Vai trò của học theo lộ trình}
...
\section{Kết hợp CL với LSTM và ICM}
...
\section{Tác động của tín hiệu dẫn đường}
...
\section{Lưới không gian cục bộ trong huấn luyện trực tiếp}
\label{sec:run62_local_grid}

Sau khi run59 cho thấy tín hiệu điều hướng tạo cải thiện rõ rệt, run62 được thiết kế như một cấu hình mở rộng để kiểm tra liệu tác nhân có thể tiến gần mức hiệu năng đó mà không nhận trực tiếp hướng đi tối ưu hay không. Mục tiêu là để tác nhân tự khai thác bố cục cục bộ thay vì dựa vào BFS. Cấu hình này thay quan sát 207 chiều bằng lưới cục bộ $15 \times 15$ (432 chiều), dùng CL 4 bậc, bật ICM với hệ số 0.001 và đặt \textbf{aggressive\_seek} để kẻ địch truy đuổi chủ động hơn. Run62 được huấn luyện trên 8 môi trường song song qua hai phiên chạy, tổng cộng \textbf{40.82M bước}. Vì thay đổi đồng thời quan sát, CL, ICM, siêu tham số, thời lượng huấn luyện và một số yếu tố môi trường, run62 được xem là bằng chứng thăm dò của một cấu hình kết hợp, không phải thí nghiệm đơn biến cho riêng lưới không gian cục bộ.
