...
\begin{itemize}
    ...
    \item \textbf{Đầu ra (hành động $a_t$)}: bốn nhánh rời rạc $(3,3,3,9)$ gồm di chuyển trục X, di chuyển trục Y, ý định chiến đấu (none/attack/dash) và hướng ngắm.
    ...
    \item \textbf{Tiêu chí thành công}: tỷ lệ dọn phòng tail-50 $\geq 0.5$ trên phân phối bản đồ Hard sinh bởi PCGNN.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{MT2}: Giải quyết bài toán phần thưởng thưa và phân phối bản đồ thay đổi bằng cách kết hợp học theo chương trình (curriculum learning) với bản đồ sinh bởi PCGNN.
    \item \textbf{MT3}: Xác định kỹ thuật hỗ trợ nào (ICM, RND, LSTM) thực sự tác động đến hiệu năng thông qua ma trận thí nghiệm loại trừ (ablation).
    \item \textbf{MT4}: Kiểm tra giả thuyết rằng biểu diễn quan sát là nút thắt của bài toán, đồng thời đánh giá khả năng cải thiện điều hướng mà không mã hóa sẵn cơ chế tìm đường cho tác nhân.
\end{itemize}
...
\begin{itemize}
    ...
    \item Run59 (\emph{path-informed}, bổ sung đặc trưng BFS) cho thấy tìm đường là một nút thắt quan trọng; run62 (432 chiều, 33.45M bước) đưa entropy xuống 3.099 nat và đạt clear\_rate 0.626 mà không cần cài cứng BFS.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Chương 2}: Thiết kế hệ thống -- Tổng quan quy trình đầu cuối, đặc tả MDP, quan sát, không gian hành động, hàm phần thưởng, quy trình PCGNN và khung curriculum learning.
	\item \textbf{Chương 3}: Cài đặt và thực nghiệm -- Môi trường phần cứng/phần mềm, CombatAgent, cấu hình PPO và ma trận thí nghiệm loại trừ (9 cấu hình ablation + run59 + run62).
