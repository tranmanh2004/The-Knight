...
Về thiết kế hệ thống, đề tài xây dựng CombatAgent trong Unity ML-Agents. Tác nhân sử dụng quan sát có cấu trúc thay vì ảnh pixel để tăng hiệu quả mẫu, đồng thời giữ lại các thông tin quan trọng của môi trường như trạng thái người chơi, kẻ địch, đạn và tường. Không gian hành động được thiết kế theo dạng rời rạc nhiều nhánh để tác nhân có thể đồng thời điều khiển hướng di chuyển, ý định chiến đấu và hướng ngắm.
...
\begin{itemize}
    ...
    \item Thiết kế và đánh giá học theo chương trình cho môi trường chiến đấu sinh theo thủ tục. Kết quả cho thấy cách huấn luyện này là yếu tố tạo cải thiện lớn nhất, tăng khoảng 85\% phần thưởng ở mức Hard so với PPO cơ sở.
    \item Thực hiện ma trận thí nghiệm loại trừ với các cấu hình PPO cơ sở, ICM, RND, LSTM, học theo chương trình, thí nghiệm kết hợp và thiết kế lại phần thưởng để phân tích vai trò của từng kỹ thuật.
    \item Ghi nhận các kết quả ablation có giá trị: ICM, RND và LSTM không tạo cải thiện đột phá rõ rệt khi chạy độc lập; ICM chỉ tạo cộng hưởng đáng kể khi được ghép sau học theo chương trình.
    \item Phát hiện hiện tượng entropy bão hòa quanh 4.40 nat trong nhiều cấu hình, gợi ý rằng không gian hành động và cấu trúc chính sách là hướng cần nghiên cứu tiếp.
\end{itemize}
