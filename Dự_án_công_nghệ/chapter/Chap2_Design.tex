...
\section{Tổng quan và mô hình bài toán}
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[
        >=stealth,
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{3.4cm}|p{4.5cm}|p{3.5cm}|c|}
        ...
        \hline
        Quan sát 207D & Mô tả tình huống chiến đấu đủ giàu nhưng đủ gọn & §2.2.1 & MT1, MT4 \\
        \hline
        Hành động $(3,3,3,9)$ & Phối hợp đồng thời di chuyển--ngắm--chiến đấu & §2.2.2 & MT1 \\
        \hline
        Hàm thưởng định hình v1/v2 & Hướng dẫn học sớm khi tín hiệu kết quả còn thưa & §2.2.3 & MT1 \\
        \hline
        PCGNN + BFS & Phân phối bản đồ thay đổi mỗi lượt chơi & §2.3.1 & MT2 \\
        \hline
        Học theo lộ trình (CL) & Phần thưởng thưa thớt và trễ & §2.3.2 & MT2 \\
        \hline
        PPO + Actor-Critic & Cập nhật chính sách ổn định trên không gian hành động đa nhánh & §2.4 & MT1, MT3 \\
        \hline
    \end{tabular}
\end{table}

\subsection{Mô hình hóa dưới dạng POMDP}
...
\section{Thiết kế không gian bài toán}

Phần này đặc tả ba thành phần cốt lõi xác định không gian bài toán của tác nhân: vector quan sát mô tả những gì tác nhân nhận được từ môi trường, không gian hành động rời rạc nhiều nhánh xác định những gì tác nhân có thể làm, và hàm phần thưởng định hướng quá trình học hướng tới mục tiêu chiến đấu.
...
Cách tiếp cận được chọn là tách bốn nhóm thông tin (tác nhân, kẻ địch, đạn, tường) thành các đoạn cố định: kẻ địch và đạn mã hóa theo tọa độ tương đối; tường dùng 16 tia ray thay vì lưới để giảm chiều; vị trí thiếu đối tượng đệm bằng 0. Nhờ đó, vector đầu vào luôn cố định ở 207 chiều dù số lượng đối tượng thay đổi theo từng lượt chơi.
...
\subsection{Thiết kế hàm phần thưởng}
...
\section{Hệ thống sinh bản đồ và lộ trình học}

Để tác nhân học khái quát hóa qua nhiều cấu hình phòng (MT2), hệ thống cần vừa tạo ra đa dạng bản đồ, vừa tổ chức thứ tự tiếp xúc theo lộ trình từ dễ đến khó. Hai mục dưới đây đặc tả lần lượt cơ chế sinh và phân loại bản đồ bằng PCGNN, và khung học theo lộ trình tích hợp với ML-Agents.

\subsection{Sinh bản đồ bằng PCGNN và TilemapGenerator}
...
\subsection{Khung học theo lộ trình}
...
\section{Kiến trúc mạng và cấu hình huấn luyện}
